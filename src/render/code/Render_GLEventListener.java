...
class Room {
    ...
    public Room(GL3 gl, Camera c, Light l, SkyboxModel s) {
        ...
        wall[3] = makeWall3(gl);
        egg = makeEgg(gl);
        lamp1 = new Lamp(gl, c, l, s, new Vec3(-5.0f, -3.5f, -2.0f));
        lamp2 = new Lamp(gl, c, l, s, new Vec3(5.0f, -3.5f, 0.5f));
        setLamp1Pos(0);
        setLamp2Pos(0);
    }
    ...
    private void loadTextures(GL3 gl) {
        texture_wall = TextureLibrary.loadTexture(gl, "src/resources/textures/wood_wall_color.png");
        texture_wall_specular = TextureLibrary.loadTexture(gl, "src/resources/textures/wood_wall_specular.jpg");
        texture_floor = TextureLibrary.loadTexture(gl, "src/resources/textures/wood_floor.png");
    ...
    private Model makeWall0(GL3 gl) {
        ...
        return new Model(gl, camera, light, skybox, shader, material, modelMatrix, mesh, texture_floor);
    }
    ...
    private Model makeWall1(GL3 gl) {
        ...
        Mesh mesh = new Mesh(gl, TwoTriangles.vertices.clone(), TwoTriangles.indices.clone());
        Shader shader = new Shader(gl, "src/render/code/shaders/vs_tt_05.txt", "src/render/code/shaders/fs_tt_05.txt");
        return new Model(gl, camera, light, skybox, shader, material, modelMatrix, mesh, texture_wall, texture_wall_specular);
    }
    ...
    private EggModel makeEgg(GL3 gl) {
        ...
        return new EggModel(gl, camera, light, skybox, shader, material, modelMatrix, eggModel, texture_egg_albedo, texture_egg_specular);
    }
